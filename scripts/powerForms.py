...
def genRegionInfo(self):
 ...
 outStr+='\\item[--] \\textbf{Конус} перед героем. При сотворении Феномена герой может определить, насколько широким будет конус, но он не может быть больше, чем полукруг. Размах конуса не влияет на силу эффектов и затраты Энергии на сотворение Феномена.'
# outStr+='\\item[--] \\tbd'
 outStr+='\\end{itemize}'
