...
def genProjectileInfo(self):
  ...
  # outStr+=prop+' к Снарядам равно Защите цели.'
  outStr+='\\item Сопротивление к Снарядам не применяется.'
...
def genBombInfo(self):
  ...
  outStr+='\\begin{itemize}'
  outStr+='\\item Если в описании не сказано иначе, то Сопротивление к Бомбам не применяется.'
  outStr+='\\end{itemize}'
  ...
  # prop='Сопротивление'
  # self.props[prop]=False
  # outStr+=prop+' к Бомбам равно Защите цели.'
...
def genMarkInfo(self):
  ...
  prop='Сопротивление'
  self.props[prop]=True
  outStr+='\\item '+prop+' к Метке указано в описании.'
  outStr+='\\end{itemize}'
  return outStr
...
def genRegionInfo(self):
  ...
  prop='Сопротивление'
  self.props[prop]=True
  outStr+='\\item '+prop+' к Области указано в описании. Используйте Коллективную проверку, чтобы быстрее определить влияние Области на группу существ.'
  outStr+='\\end{itemize}'
...
def genSummonInfo(self):
  ...
  prop='Сопротивление'
  self.props[prop]=True
  outStr+='\\newline \\textbf{'+prop+'} к призыву указано в описании.'
  return outStr
