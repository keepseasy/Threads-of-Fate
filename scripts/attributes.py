...
def genEntity(entityDict):
 ...
 for key in entityDict:
  ...
  outStr+='\\paragraph{'+entity.get('название Трюка Атрибута','\\err не задано название трюка')
  outStr+=':} '+entity.get('описание Трюка','\\err не задано описание трюка')
  outStr+='\\paragraph{Ход — '+entity.get('название Хода Атрибута','\\err не задано название Хода')
